...
const DUFAFloatingNavigation: React.FC<DUFAFloatingNavigationProps> = ({
  ...
  return (
    <div className={cn(
      ...
      {/* Navigation Controls */}
      <Card className="p-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm shadow-lg border-0">
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-105 transition-all duration-200"
            title="Scroll to top"
          >
          ...
          <Button
            ...
            className={cn(
              "flex items-center gap-2 transition-all duration-200",
              canGoNext 
                ? "hover:bg-viz-accent hover:text-white hover:scale-105" 
                : "opacity-50 cursor-not-allowed"
            )}
          >
