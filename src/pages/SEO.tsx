...
const SEO: React.FC = () => {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-cyan-50 via-white to-blue-50 dark:from-gray-900 dark:via-cyan-900 dark:to-blue-900 relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-8">
        ...
        >
          <Link to="/">
            <Button 
              variant="outline" 
              className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 border-cyan-200/50 dark:border-blue-400/30 rounded-xl hover:bg-white dark:hover:bg-gray-700 transition-all duration-300"
            >
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <motion.div
              ...
              className="p-3 bg-gradient-to-br from-cyan-600 to-blue-600 rounded-2xl shadow-lg"
            >
          ...
          <motion.h1 
            ...
            className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-black bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-700 bg-clip-text text-transparent mb-6 tracking-tight px-4 leading-tight"
          >
            Master SEO and GEO
          </motion.h1>
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 backdrop-blur-sm border border-cyan-200/20 dark:border-blue-400/20 rounded-full mb-6"
          >
