...
const DataControl = () => {
  ...
  return (
    <div>
      <h1>Data Control Page</h1>
      <p>This is a placeholder for the Data Control content.</p>
      {/* Data Connections Tab */}
      <TabsContent value="connections" className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="rounded-lg border p-6 flex flex-col items-center justify-center bg-white dark:bg-viz-medium">
            <h3 className="font-semibold mb-2">CSV / XLSX Upload</h3>
          ...
          <div className="rounded-lg border p-6 flex flex-col items-center justify-center bg-white dark:bg-viz-medium opacity-60 cursor-not-allowed">
            <h3 className="font-semibold mb-2">BigQuery</h3>
            <p className="text-sm text-viz-text-secondary mb-4">Connect to Google BigQuery</p>
            <span className="viz-badge-warning">WIP</span>
          </div>
          <div className="rounded-lg border p-6 flex flex-col items-center justify-center bg-white dark:bg-viz-medium opacity-60 cursor-not-allowed">
            <h3 className="font-semibold mb-2">Redshift</h3>
      ...
      <TabsContent value="schema" className="space-y-6">
        <div className="rounded-lg border p-6 bg-white dark:bg-viz-medium">
